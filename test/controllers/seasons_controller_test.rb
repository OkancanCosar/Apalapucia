...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { availablity: @season.availablity, end_date: @season.end_date, start_date: @season.start_date } }
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { availablity: @season.availablity, end_date: @season.end_date, start_date: @season.start_date } }
